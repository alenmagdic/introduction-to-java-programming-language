...
public class ArrayIndexedCollection extends Collection {
	...
	public ArrayIndexedCollection(int initialCapacity) {
		if (initialCapacity < 1) {
			throw new IllegalArgumentException("Inicijalni kapacitet mora biti pozitivan broj.");
		}
	...
	public ArrayIndexedCollection(Collection collection, int initialCapacity) {
		if (initialCapacity < collection.size()) {
			throw new IllegalArgumentException("Inicijalni kapacitet treba biti veći ili jednak od dane kolekcije.");
		}
		capacity = initialCapacity;
